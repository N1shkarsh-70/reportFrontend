...
const AdminAttendanceManagement = () => {
  ...
  const apiUrl = "https://backendreport.onrender.com/api/attendence/generate-attendance"
              ...
              allAttendance.map((record) => (
                <tr key={record._id} className="border-t border-gray-200 hover:bg-gray-50 transition">
                  ...
                  <td className="px-4 py-2">
                    <span
                      className={`inline-block px-2 py-1 text-sm font-semibold rounded-full ${record.status === 'present' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                        }`}
                    >
                      {record.status}
                    </span>
